...
public class SystemUiHiderHoneycomb extends SystemUiHiderBase {
	...
	/**
	 * Flags to test against the first parameter in {@link android.view.View.OnSystemUiVisibilityChangeListener#onSystemUiVisibilityChange(int)} to determine
	 * the system UI visibility state.
	 */

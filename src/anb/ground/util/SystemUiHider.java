 ...
 * implementations of this abstract class: for newer devices, {@link #getInstance} will return a {@link SystemUiHiderHoneycomb} instance,
 * while on older devices {@link #getInstance} will return a {@link SystemUiHiderBase} instance.
 * <p>
...
public abstract class SystemUiHider {
	/**
	 * When this flag is set, the {@link android.view.WindowManager.LayoutParams#FLAG_LAYOUT_IN_SCREEN} flag will be set on older devices, making the status bar
	 * "float" on top
	 * of the activity layout. This is most useful when there are no controls at
	 * the top of the activity layout.
	 * <p>
	 * This flag isn't used on newer devices because the <a href="http://developer.android.com/design/patterns/actionbar.html">action bar</a>, the most
	 ...
	 * appropriate for this device. The object will be either a {@link SystemUiHiderBase} or {@link SystemUiHiderHoneycomb} depending on
	 * the device.
	 * 
	 * @param activity
